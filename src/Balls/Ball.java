...
/**
 * All client ball should : 
 * have the basic info : x, y, size, imagePath
 * and the info used to trade off server delay : attack, scope,  
 *
 */
public abstract class Ball
{
	...
	public Object getShape() {
		return new Ellipse2D.Double(this.x.get()-Configs.DragonImageSize, this.y.get() - Configs.DragonImageSize, XSIZE, YSIZE);
	}
	...
	public BufferedImage getImage() {
		...
		if (this.image == null) {
			try {
				...
				this.image = ImageHelper.resizeImage(Configs.ImageWidth,
						Configs.ImageHeight, originalImage,
