...
/**
 * 
 * 0, wrap client ball request and send to server. 
 * 1, show balls on the client side. 
 * 2, show server ball response on the client side. 
 */
public class BallManager{
	...
	public synchronized void addBall(String ballName, int x, int y, Object obj0, int pvpBallID) {
		if (x >= Config.mapWidth || x <= 0
				|| y >= Config.mapHeight || y <= 0)
			return;
		y -= 24;
		Ball ball = null;
		switch (ballName) {
